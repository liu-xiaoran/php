...
<html>
    ...
    <li><a href="javascript:;"><span>4</span><?php if(($_SESSION['w_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></a></li>
	...
	<div class="notice">
    <h1>WeiPHP V4.0 安装协议</h1>
    <p>版权所有 (c) 2017，深圳市圆梦云科技有限公司保留所有权利。</p>

    <p>感谢您选择WeiPHP，希望我们的努力能为您提供一个简单、强大、易扩展和定制开发的微信开发方案。产品官方网站网址为 <a href="https://www.weiphp.cn" target="_blank">https://www.weiphp.cn</a>。</p>
	...
	<p>WeiPHP遵循Apache Licence2开源协议（但不包括其衍生产品、插件或者服务）。Apache Licence是著名的非盈利开源组织Apache采用的协议。该协议和BSD类似，鼓励代码共享和尊重原作者的著作权，允许代码修改，再作为开源或商业软件发布。需要满足的条件：<br/>
